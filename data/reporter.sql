...
CREATE TABLE `department_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор сотрудника подразделения.',
  `departmentid` int(11) NOT NULL COMMENT 'Идентификатор подразделения.',
  `userid` int(11) NOT NULL COMMENT 'Идентификатор пользователя.',
  `postid` int(11) NOT NULL COMMENT 'Идентификатор должности.',
  PRIMARY KEY (`id`),
  KEY `FK_department_users_department` (`departmentid`),
  KEY `FK_department_users_user` (`userid`),
  KEY `FK_department_users_post` (`postid`),
  CONSTRAINT `FK_department_users_department` FOREIGN KEY (`departmentid`) REFERENCES `department` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
